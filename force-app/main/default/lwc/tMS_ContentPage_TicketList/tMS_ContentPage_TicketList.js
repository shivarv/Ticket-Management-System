...
export default class TMS_ContentPage_TicketList extends LightningElement {
    ...
    constructor() {
        super();
        this.currentTicketUpdate = [];
        this.currentTicketUpdate.push({id : 1, contactName: 'Raj', subject: 'Connecting issue in laptop',
            currentTicketUpdate : 'closed on time . resolution on time',
            ticketStatus: 'Open',
            ticketPriotity: 'Low'
        });

        this.currentTicketUpdate.push({id : 2 ,contactName: 'Vis', subject: 'New Keyboard',
